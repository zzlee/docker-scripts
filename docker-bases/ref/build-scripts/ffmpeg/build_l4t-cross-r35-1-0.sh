...
cd /docker/qcap/build-3rdparty/l4t-cross-r35-1-0/ffmpeg
...
EXTRA_CFLAGS="-I/docker/qcap/3rdparty/l4t-cross-r35-1-0/include"
ADDI_CFLAGS="-Ofast -fPIC $EXTRA_CFLAGS -pthread"
ADDI_LDFLAGS="-pthread -L/docker/qcap/3rdparty/l4t-cross-r35-1-0/lib"
ADDI_LIBS="-lm -ldl"

export PKG_CONFIG_PATH=/docker/qcap/3rdparty/l4t-cross-r35-1-0/lib/pkgconfig
build_one