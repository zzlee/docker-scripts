...
cd /docker/qcap/build-3rdparty/ubuntu2004_x64/ffmpeg-vaapi

function build_one
{
    ./configure \
        --prefix=/docker/qcap/3rdparty/ubuntu2004-vaapi_x64/ \
...
export PKG_CONFIG_PATH=/docker/qcap/3rdparty/ubuntu2004_x64/lib/pkgconfig
build_one
