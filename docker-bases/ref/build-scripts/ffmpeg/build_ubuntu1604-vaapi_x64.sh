...
cd /docker/qcap/build-3rdparty/ubuntu1604_x64/ffmpeg-vaapi

function build_one
{
    ./configure \
        --prefix=/docker/qcap/3rdparty/ubuntu1604-vaapi_x64/ \
...
export PKG_CONFIG_PATH=/docker/qcap/3rdparty/ubuntu1604_x64/lib/pkgconfig
build_one
