...
cd /docker/qcap/build-3rdparty/ubuntu1804_x64/ffmpeg-vaapi

function build_one
{
    ./configure \
        --prefix=/docker/qcap/3rdparty/ubuntu1804-vaapi_x64/ \
...
export PKG_CONFIG_PATH=/docker/qcap/3rdparty/ubuntu1804_x64/lib/pkgconfig
build_one
