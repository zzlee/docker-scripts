...
DOCKER_IMAGE:=yuan88yuan/ubuntu2004_x64:v1
...
install-3rdparty_prebuilt:
	...
	@cp prebuilt-3rdparty/ubuntu2004-vaapi_x64 3rdparty/ -arf
	@cp prebuilt-3rdparty/ubuntu2004-cuda_x64 3rdparty/ -arf

#################################################################################
## boost

clean-3rdparty_boost:
...
build-3rdparty/${PLATFORM}/ffmpeg-vaapi/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_ubuntu2004-vaapi_x64.sh

#################################################################################
## ffmpeg-cuda

clean-3rdparty_ffmpeg-cuda:
...
build-3rdparty/${PLATFORM}/ffmpeg-cuda/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_ubuntu2004-cuda_x64.sh
