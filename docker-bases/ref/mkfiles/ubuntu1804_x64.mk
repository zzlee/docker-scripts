...
DOCKER_IMAGE:=yuan88yuan/ubuntu1804_x64:v1
...
install-3rdparty_prebuilt:
	...
	@cp prebuilt-3rdparty/ubuntu1804-vaapi_x64 3rdparty/ -arf
	@cp prebuilt-3rdparty/ubuntu1804-cuda_x64 3rdparty/ -arf
...
build-3rdparty/${PLATFORM}/ffmpeg-vaapi/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_ubuntu1804-vaapi_x64.sh
...
build-3rdparty/${PLATFORM}/ffmpeg-cuda/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_ubuntu1804-cuda_x64.sh
