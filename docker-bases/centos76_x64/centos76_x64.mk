...
DOCKER_IMAGE:=yuan88yuan/centos76_x64:v1
...
build-3rdparty/${PLATFORM}/ffmpeg-vaapi/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_centos76-vaapi_x64.sh
...
build-3rdparty/${PLATFORM}/ffmpeg-cuda/DONE: \
	...
	${DOCKER_BUILD} ${BUILD_SCRIPT_HOME}/ffmpeg/build_centos76-cuda_x64.sh
