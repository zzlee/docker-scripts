...
cd /docker/qcap/build-3rdparty/centos76_x64/ffmpeg-vaapi

function build_one
{
    ./configure \
        --prefix=/docker/qcap/3rdparty/centos76-vaapi_x64/ \
...
export PKG_CONFIG_PATH=/docker/qcap/3rdparty/centos76_x64/lib/pkgconfig
build_one
